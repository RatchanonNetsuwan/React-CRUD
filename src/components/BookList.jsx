...
export default function BookList() {
  ...
  useEffect(() => {
    axios
      .get("https://node57032-ratchanon-noderest.proen.app.ruk-com.cloud/books")
      .then((response) => {
  ...
  const viewBook = (id) => {
    axios
      .get(`https://node57032-ratchanon-noderest.proen.app.ruk-com.cloud/books/${id}`)
      .then((response) => {
  ...
  const updateBook = (book) => {
    ...
    // axios
    //   .put(`https://node57032-ratchanon-noderest.proen.app.ruk-com.cloud/books/${id}`)
    //   .then((response) => {
    //     setBook(response.data);
    //   });
  };
  ...
  const deleteBook = (id) => {
    axios
      .delete(`https://node57032-ratchanon-noderest.proen.app.ruk-com.cloud/books/${id}`)
      .then(() => {
